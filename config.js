...
global.sig = 'https://instagram.com/RanggaHalal' //Link Instagrammu
global.sgh = 'https://github.com/RanggaKing' //Link Githubmu
global.sgc = 'https://chat.whatsapp.com/Dvp1AjdfojrDvHulh4r3YR'
global.sdc = '-' //Isi Pake Link Discordmu Kalo Gada Biarin aja
global.snh = 'https://nhentai.net/' //Hmmm, Ini boleh kalian isi terserah :v

/*============== PAYMENT ==============*/
global.pdana = '-' //Nomor Danamu
global.ppulsa = '087775704633' //Nomor SimCard Yang Kamu Pake
global.psaweria = '-' //Link Saweriamu Kalo Nggada Ketik - aja

/*============== NOMOR ==============*/
global.nomorbot = '6281717250393' //Nomor Bot
global.nomorown = '6287775704633' //Nomor Owner
global.namebot = 'Malaz BOT' //Nama Bot
global.nameown = 'Rangga suaminya elaina' // Nama Owner


/*============== STAFF ==============*/
global.owner = [
  ['6287775704633', '❦ 𝚇Rangga? 🎐', true] //Ganti jd nomormu sama Namamu
...
/*============== WATERMARK ==============*/
global.wm = '                「 ᴍᴀʟᴀᴢ 𝙱𝙾𝚃 汉  」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘ᴍᴀʟᴀᴢ - ᴄʜᴀɴ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ ᴍᴀʟᴀᴢ 𝙱𝙾𝚃'
global.namedoc = 'Malaz`s Bot' //Main Name Menu Document
...
global.packname2 = 'ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴍᴀʟᴀᴢ ʙᴏᴛᴢ'
